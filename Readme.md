...
**_Я случайно не через ту папку работал на семинаре, поэтому сохранения с семинара пришлось удалить тк там задействовалась вся папка с работами с лекций, но коммиты с ДЗ все на месте._**